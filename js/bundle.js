...
},{"../events":7,"../zvs/zvs":36,"./kanban":8,"./transitions/definitions/prepare":14,"./transitions/index":16}],10:[function(require,module,exports){
...
},{"./unify":25}],11:[function(require,module,exports){
...
},{"../../../match/match":28,"../../../utils":30,"../../../zvs/zvs":36}],12:[function(require,module,exports){
const ZVS = require("../../../zvs/zvs");
...
},{"../../../zvs/zvs":36,"../unify":25,"./prepare":14}],13:[function(require,module,exports){
const prepare = require("./prepare");
...
},{"./prepare":14}],14:[function(require,module,exports){
function clone (obj) {
...
},{"./check":10,"./definitions/check-definitions":11,"./definitions/multiply-definitions":12,"./definitions/prepare-definitions":13,"./include":15,"./merge":17,"./negations":18,"./negations/filter-unchecked-negations":19,"./parse":20,"./query/check-depth":21,"./query/filter-unchecked-tuples":22,"./query/prepare-query":23,"./query/update-query":24,"./unify/copy-definitions":26,"./unify/match-tuples":27}],17:[function(require,module,exports){
const actionUnify = require("./unify");
const utils = require("../../utils");
...
},{"../../utils":30,"./unify":25}],18:[function(require,module,exports){
...
},{"../../zparser":32}],21:[function(require,module,exports){
...
},{"../../../match/match":28,"../definitions/prepare":14}],24:[function(require,module,exports){
const utils = require("../../../utils");
...
},{"../../unify":29}],26:[function(require,module,exports){
const prepare = require("../definitions/prepare");
...
},{"../definitions/prepare":14}],27:[function(require,module,exports){
...
},{"../utils":30,"../zvs/ids":35}],29:[function(require,module,exports){
...
},{"./manager/transitions/definitions/prepare":14}],30:[function(require,module,exports){
...
},{"./manager/manager":9}],32:[function(require,module,exports){
/*
...
},{"./ids":35}],34:[function(require,module,exports){
(function (global){
const Ids = require("./ids");
...
},{"./ids":35}],35:[function(require,module,exports){
class Ids {
...
},{"../events":7,"./branches":33,"./data":34}],37:[function(require,module,exports){
var config = {
    appname: 'raindropz',
    prefix: 'rz',
...
App.prototype.init = function () {
    templates.load("rz-app", './templates/app.html', this.scope).then(function () {
...
},{"../services/templates":48,"./filetree":40,"./tabs":43}],39:[function(require,module,exports){
var templates = require("../services/templates");
...
},{"../services/events":45,"../services/filesystem":46,"../services/run":47,"../services/templates":48}],40:[function(require,module,exports){
var templates = require('../services/templates');
var filesystem = require('../services/filesystem');
var events = require('../services/events');
...
function open() {
	...
	if (file.type === filesystem.types.DIRECTORY) {
		if (file.childs) {
			...
			filesystem.ls(file.id).then(function (childs) {
				file.childs = childs;
				file.icon = fileicon(file);
			});
		}
...
function setup() {
	return fetch("./res/introduction.z").then(function (response) {
		if (response.status === 200) {
			response.text().then(function (data) {
				return filesystem.create("introduction.z", {
					silent: true,
...
FileTree.prototype.init = function (el, elWorkArea) {
	return setup().then(function () {
		filesystem.ls().then(function (root) {
			filetree(document.getElementById(el), root);
		});
	});
};
...
},{"../services/events":45,"../services/filesystem":46,"../services/templates":48}],41:[function(require,module,exports){
var templates = require("../services/templates");
var d3 = require("d3");
...
class Run {
    ...
    removeNode(branch) {
        ...
        if (this.tree.data[branchId]) {
            ...
            this.tree.nodes.filter(branch => {
                return branch.data.parent !== undefined && (branch.data.parent instanceof Array ? branch.data.parent.indexOf(branchId) !== -1 : branch.data.parent === branchId);
            }).forEach(branch => {
    ...
    draw(sTree) {
        ...
        // remove,
        this.elLinks.selectAll("line").data(this.tree.links, dataTrack).exit().remove().transition().duration(750).delay(function (d, i) {
            return i * 10;
        });

        this.elNodes.selectAll("circle").data(this.tree.nodes, dataTrack).exit().remove().transition().duration(750).delay(function (d, i) {
            return i * 10;
        });

        // update,
        this.elLinks.selectAll("line").data(this.tree.links, dataTrack).transition().duration(750).delay(function (d, i) {
            return i * 10;
        ...
        this.elNodes.selectAll("circle").data(this.tree.nodes, dataTrack).transition().duration(750).delay(function (d, i) {
            return i * 10;
        ...
        // add
        this.elLinks.selectAll("line").data(this.tree.links, dataTrack).enter().append("line").transition().duration(750).delay(function (d, i) {
            return i * 10;
        }).attr("x1", function ({ parent: branch }) {
            return branch.metadata.geometry.cx;
        }).attr("y1", function ({ parent: branch }) {
            ...
            return branch.metadata.geometry.line;
        }).attr("stroke", "black").attr("class", "link");

        this.elNodes.selectAll("circle").data(this.tree.nodes, dataTrack).enter().append("circle").on('click', branch => {
    ...
    init(el) {
        return templates.load(el, "./templates/run.html", this).then(() => {
            this.elLinks = d3.select(el).select(".run-tree").append("g");

            this.elNodes = d3.select(el).select(".run-tree").call(d3.zoom().on("zoom", () => {
...
},{"../services/templates":48,"../services/z/zsession":49,"d3":1}],42:[function(require,module,exports){
var templates = require("../services/templates");
var filesystem = require("../services/filesystem");
...
Settings.prototype.init = function (el) {
	...
	if (this.file.type === filesystem.types.DIRECTORY) {
		this.createDirectory = function () {
			filesystem.create(self.inputs.directory, {
		...
		this.createFile = function () {
			filesystem.create(self.inputs.file, {
				type: filesystem.types.FILE,
				parentID: self.file.id,
				data: ""
			}).then(function () {
		...
		templates.load(el, "./templates/directory_settings.html", this);
	} else {
		templates.load(el, "./templates/file_settings.html", this);
	}
};

module.exports = Settings;

},{"../services/filesystem":46,"../services/templates":48}],43:[function(require,module,exports){
var events = require('../services/events');
var templates = require('../services/templates');
...
Group.prototype.setItem = function (data, Widget, widget) {
    ...
    widget = widget || this.widgets.find(function (a) {
        return a.id === data.id;
    });
...
},{"../services/events":45,"../services/templates":48,"./editor":39,"./run":41,"./settings":42}],44:[function(require,module,exports){
(function () {
...
},{"./controllers/app":38,"promise-polyfill":3,"whatwg-fetch":6}],45:[function(require,module,exports){
...
function ls(id) {
    return getFileTable().then(function (filetable) {
        ...
        var r;
        if (id === undefined) {
            r = Object.assign({}, filetable.records[filetable.root]);
            ...
            for (var i = 0; i < parent.childs.length; i++) {
                r = Object.assign({}, filetable.records[parent.childs[i]]);
...
},{"../config":37}],47:[function(require,module,exports){
...
},{"./filesystem":46,"zebrajs":31,"zebrajs/lib/utils":30}],48:[function(require,module,exports){
...
rivets.load = function (elem, file, state) {
	return fetch(file).then(function (html) {
		if (html.status === 200) {
			var el = elem;
			...
			return html.text().then(function (html) {
				el.innerHTML = html;
...
},{"moment":2,"rivets":4}],49:[function(require,module,exports){
const sessions = {};
...
class Session {
    ...
    readFile(fileId) {
        ...
        filesystem.open(fileId).then(function (data) {
            zworker.postMessage({
                action: 'readfile',
                data: {
                    fileId,
...
},{"../filesystem":46,"zebrajs/lib/events":7}]},{},[44]);
